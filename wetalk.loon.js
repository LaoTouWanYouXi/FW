...
http-request ^https:\/\/api\.wetalkapp\.com\/app\/queryBalanceAndBonus script-path=https://你的链接/wetalk.loon.js, timeout=60, tag=WeTalk抓包

# 定时签到任务（每天 8:20 和 20:20 执行）
cron "20 8,20 * * *" script-path=https://你的链接/wetalk.loon.js, tag=WeTalk签到, wake-system=1
